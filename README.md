...
12. 🔁 Encapsulation Concept <br>
📅 Date: 10-02-2025 <br> 📝 Submission Details: <br> The submission includes the following concepts: <br>

Encapsulation 🔒 <br>
Polymorphism 🔄 <br>
Interface 🖥️ <br>
Abstract Class 🏗️ <br> 💡 Questions:
There were a total of 8 questions that were covered. 📚 <br> These are stored in the branch: features_10-02-2025 🌿 <br><br>

---<br>

13. 🔁 LinkedList Concept <br>
📅 Date: 11-02-2025 <br> 📝 Submission Details: <br> The submission includes the following concepts: <br>

Singly Linked List 🔗 <br>
Doubly Linked List 🔄 <br>
Circular Linked List 🔄🔁 <br> 💡 Questions:
There were a total of 9 questions that were covered. 📚 <br> These are stored in the branch: features_11-02-2025 🌿 <br><br>
