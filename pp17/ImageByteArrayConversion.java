...
public class ImageByteArrayConversion {
    public static void main(String[] args) {
        ...
        try {
            ...
            writeByteArrayToImage(destinationImage, imageBytes);
            System.out.println("Image has been successfully converted and saved.");
        } catch (IOException e) {
    ...
    public static void writeByteArrayToImage(String imagePath, byte[] imageBytes) throws IOException {
